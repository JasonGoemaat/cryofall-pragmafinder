...
namespace MyMod.UI.MyMiniMap.Data
{
    public class ViewModelMyMiniMap : BaseViewModel
    {
        ...
        public ViewModelMyMiniMap(FrameworkElement rootElement, Action callbackSizeOrZoomChanged)
        {
